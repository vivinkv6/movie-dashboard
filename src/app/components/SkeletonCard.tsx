const SkeletonCard = () => {
  ...
  .map((_, index) => {
    return (
      <div
        key={index}
        className={`min-w-full max-sm:mx-20 p-4 rounded-lg `}
      >
        <div className="mb-2 rounded ">
          <div className="w-full h-64 bg-gray-700 rounded-md bg-gradient-to-r from-gray-700 via-gray-500 to-gray-700 bg-size-200 bg-pos-0 animate-shimmer"></div>
